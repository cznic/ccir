...
func main() {
	...
	for _, v := range []struct{ os, nm, mre, dre string }{
		...
		{"windows", "windows", "ERROR_ACCESS_DENIED|__MSABI_LONG|__MINGW_NAME_AW", "CRITICAL_SECTION|wchar_t|WORD|HANDLE|GUID|SOCKET|u_int|timeout|_func__|PTIMEVAL|in_addr|QueryPerformanceCounter"},
		{"windows", "malloc", "TODO", "_msize|size_t"},
		{"windows", "inttypes", "PRI", "wchar_t"},
		{"windows", "io", "TODO", "_isatty|__time32_t|_off64_t"},
		{"windows", "locale", "__LC_ALL", "setlocale|_locale_t"},
		{"windows", "fcntl", "F_WRLCK|_O_BINARY", "_off64_t|__time32_t|open|struct flock|__off_t"},
		{"linux", "fcntl", "F_WRLCK", "_off64_t|__time32_t|open|struct flock|__off_t"},
		{"linux", "sched", "TODO", "sched_yield|__pid_t"},
		{"linux", "locale", "__LC_ALL", "setlocale"},
		{"linux", "inttypes", "PRI", "TODO"},
