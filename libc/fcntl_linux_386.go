...
const (
	...
	Xfcntl__MKNOD_VER                = 1
	Xfcntl__MKNOD_VER_LINUX          = 1
	Xfcntl__MKNOD_VER_SVR4           = 2
	Xfcntl__PREDEFINED_H_            = true
	Xfcntl__STAT_VER                 = 3
	Xfcntl__STAT_VER_KERNEL          = 1
	Xfcntl__STAT_VER_LINUX           = 3
	Xfcntl__STAT_VER_LINUX_OLD       = 1
	Xfcntl__STAT_VER_SVR4            = 2
	...
	Xfcntl___INTPTR_MAX__            = 2147483647
	Xfcntl___INTPTR_TYPE__           = 0
	Xfcntl___INT_FAST16_MAX__        = 2147483647
	Xfcntl___INT_FAST16_TYPE__       = 0
	Xfcntl___INT_FAST32_MAX__        = 2147483647
	Xfcntl___INT_FAST32_TYPE__       = 0
	...
	Xfcntl___LONG_MAX__              = 2147483647
	...
	Xfcntl___PTRDIFF_MAX__           = 2147483647
	Xfcntl___PTRDIFF_TYPE__          = 0
	...
	Xfcntl___SIZEOF_FLOAT80__        = 12
	Xfcntl___SIZEOF_FLOAT__          = 4
	Xfcntl___SIZEOF_INT__            = 4
	Xfcntl___SIZEOF_LONG_DOUBLE__    = 12
	Xfcntl___SIZEOF_LONG_LONG__      = 8
	Xfcntl___SIZEOF_LONG__           = 4
	Xfcntl___SIZEOF_POINTER__        = 4
	Xfcntl___SIZEOF_PTRDIFF_T__      = 4
	Xfcntl___SIZEOF_SHORT__          = 2
	Xfcntl___SIZEOF_SIZE_T__         = 4
	Xfcntl___SIZEOF_WCHAR_T__        = 4
	Xfcntl___SIZEOF_WINT_T__         = 4
	Xfcntl___SIZE_MAX__              = 4294967295
	Xfcntl___SQUAD_TYPE              = 0
	...
	Xfcntl___UINTPTR_MAX__           = 4294967295
	Xfcntl___UINT_FAST16_MAX__       = 4294967295
	Xfcntl___UINT_FAST32_MAX__       = 4294967295
	...
	Xfcntl___linux__                 = 1
	Xfcntl___os__                    = 0
	Xfcntl___pentiumpro              = 1
	Xfcntl___pentiumpro__            = 1
	Xfcntl___restrict                = 0
	Xfcntl___unix                    = 1
	Xfcntl___unix__                  = 1
	Xfcntl___volatile                = 0
